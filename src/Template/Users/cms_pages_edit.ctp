								...
								<?= $this->element('adminElements/validations'); ?>
                                  ...
                                  <!--site settings form-->
								    <?php echo $this->Form->create(null, [
										'url' => ['controller' => 'users', 'action' => 'cms-pages-edit'],
                                   ...
                                   <?php 
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="pagename">Page Name <span class="required">*</span>
										</label>
										<?php 
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="pageurl">Page URL<span class="required">*</span>
										</label>
										<?php 
									...
									<div class="item form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for="pagecontent">Page Content<span class="required">*</span>
										</label>
