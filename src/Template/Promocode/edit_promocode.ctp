								...
								<!--Form edit user -->
									...
									<?php 
									 $promocodeId = base64_encode(convert_uuencode($promocodeInfo->id));
									  echo $this->Form->input('promocodeId',[
											'type'=>'hidden',
											'value'=>$promocodeId]);?>
									...
									<div class="item form-group">
										...
										echo $this->Form->input('PromoCodes.discount_rate',[
												...
												'label' => false,
												'class'=>'form-control col-md-7 col-xs-12',
												'value'=>$promocodeInfo->discount_rate != '' ?$promocodeInfo->discount_rate:'']);
										 ?>
									<?php if($promocodeInfo->coupon_type == 'discounted_coupon'){
									?>
							              <span id="discounted_coupon" class="ct">%</span>
									<?php
									}else{ ?>
										    <span id="fixed_coupon" class="ct">$</span>
									<?php } ?>
									</div>
									<div class="item form-group">
										...
										echo $this->Form->input('PromoCodes.start_date',[
												...
												'label' => false,
												'class'=>'form-control col-md-7 col-xs-12',
												'value'=>$promocodeInfo->start_date != '' ?$promocodeInfo->start_date:'']);
										 ?>
									</div>
									<div class="item form-group">
										...
										echo $this->Form->input('PromoCodes.expire_date',[
												...
												'label' => false,
												'class'=>'form-control col-md-7 col-xs-12',
												'value'=>$promocodeInfo->expire_date != '' ?$promocodeInfo->expire_date:'']);
										 ?>
									</div>
									<div class="item form-group">
