                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="ban-s-box">
												...
												<?php if($userInfo['user_detail']['facebook_url']) { ?>
                                                    <li>
                                                        <a class="ban-fb" title="Facebook" href="#"></a>
                                                    </li>
												<?php } ?>
												<?php if($userInfo['user_detail']['linkedin_url']) { ?>
                                                    <li>
                                                        <a class="ban-twitter" title="Twitter" href="#"></a>
                                                    </li>
												<?php } ?>
												<?php if($userInfo['user_detail']['twitter_url']) { ?>
                                                    <li>
                                                        <a class="ban-linkedin" title="LinkedIn" href="#"> </a>
                                                    </li>
												<?php } ?>
												<?php if($userInfo['user_detail']['google_url']) { ?>
                                                    <li>
                                                        <a class="ban-gplus" title="Google Plus" href="#"></a>
                                                    </li>
												<?php } ?>
                                                </ul>
                                            </div>
