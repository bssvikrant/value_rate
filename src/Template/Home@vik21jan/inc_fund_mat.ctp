<div id="menu2" class="tab-pane fade">
	...
	<div class="osum-area funding">
		...
		<div class="fundinf-text">
			<?php foreach($userInfo['user_funding_materials'] as $doc){   ?> 
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<p> <i class="fa fa-file-word-o"></i> <?php echo $doc['document_name']; ?>
							<p>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<p><?php echo date("F j, Y", strtotime($doc['create_date'])); ?></p>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<p>
