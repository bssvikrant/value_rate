...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2016 at 10:11 AM
...
(1, 'Emma Watson', 'admin', 'rahul.jain@betasoftsystems.com', '21232f297a57a5a743894a0e4a801fc3', '5CQtVd9Znao4wHs.jpg', 1, '0', '2015-01-16 00:00:00', '2016-02-18 05:46:49');
...
CREATE TABLE `contact_requests_i18n` (
  `id` int(11) NOT NULL,
  `locale` varchar(6) NOT NULL,
  `model` varchar(255) NOT NULL,
  `foreign_key` int(10) NOT NULL,
...
CREATE TABLE `site_configurations_i18n` (
  `id` int(11) NOT NULL,
  `locale` varchar(6) NOT NULL,
  `model` varchar(255) NOT NULL,
  `foreign_key` int(10) NOT NULL,
...
(50, '', 'honey@gmail.com', '', '', '', '', '', '', '4d94dea6536bac9b21da5fc99e13eed8', '068tVOPVEm', '', '2016-02-17 08:57:47', NULL, 1, ''),
(51, '', 'honey@gmail.com', '', '', '', '', '', '', 'e531f6a8785af9dc61a516a3dbe08ac1', 'M2lV7SxPO7', '', '2016-02-17 09:31:55', NULL, 1, ''),
(52, '', 'honey@gmail.com', '', '', '', '', '', '', '762ae922cb17a05643e29c4e4f36432c', '2dzpGxRxfJ', '', '2016-02-17 09:32:09', NULL, 1, ''),
...
(56, '', 'honey@gmail.com', '', '', '', '', '', '', 'e66a599ce6dcf832a63eac2c3dae9437', 'MlIZFeCxdI', '', '2016-02-17 10:54:03', NULL, 1, 'valuerater'),
(57, '', 'honey@gmail.com', '', '', '', '', '', '', '066b13426da9a666c266f98e87afaba0', 'AF706vzp6D', '', '2016-02-17 10:54:09', NULL, 1, 'valuerater'),
(58, '', 'honey@gmail.com', '', '', '', '', '', '', '7f0e5a8fbe1b7e959fc67c02afd720bc', 'MZkEzO6KNf', '', '2016-02-17 10:59:25', NULL, 1, 'valuerater'),
(59, '', 'honey@gmail.com', '', '', '', '', '', '', '95b088f933cc39842bcc0038a4dce89b', 'PQPHf2Ud4Q', '', '2016-02-17 10:59:35', NULL, 1, 'valuerater'),
(60, '', 'honey@gmail.com', '', '', '', '', '', '', '99a7eb8d7e33f790fcdda21367099a04', 'TC0VJiChob', '', '2016-02-17 11:11:37', NULL, 1, 'valuerater'),
(61, '', 'kol@gmail.com', '', '', '', '', '', '', '9e2ba8cf397a13e6bfd81660e7db3888', 'bGNAjkwUne', '', '2016-02-17 11:12:37', NULL, 1, 'valuerater'),
(62, '', 'honey@gmail.com', '', '', '', '', '', '', '686cf8cbf6aa957ae8d3093baa1195b7', '2hc6SRZFVF', '', '2016-02-17 11:20:49', NULL, 1, 'valuerater'),
(63, '', 'honey@gmail.com', '', '', '', '', '', '', 'fcf20d6081dcb449b378e993b07d6ac2', 'gQCNfrVPEO', '', '2016-02-17 11:22:11', NULL, 1, 'valuerater'),
(64, '', 'honey@gmail.com', '', '', '', '', '', '', '7944bfdf61c7b190736bc9d3856237b6', 'lSGOOw5KNR', '', '2016-02-17 11:23:05', NULL, 1, 'valuerater'),
(65, '', 'honey@gmail.com', '', '', '', '', '', '', '95faaaa840992f9c59d89f247b61a890', '63kkcmODef', '', '2016-02-17 11:24:45', NULL, 1, 'valuerater'),
(66, '', 'honey@gmail.com', '', '', '', '', '', '', '9f3615d12576b882b300abea805e2bed', 'yjlV7hfBjp', '', '2016-02-17 11:29:03', NULL, 1, 'valuerater'),
...
(69, '', 'honey@gmail.com', '', '', '', '', '', '', 'bb1bed2fc251ebe85f99a690d898bd79', 'B6Hnb1X4rE', '', '2016-02-17 11:34:15', NULL, 1, 'valuerater'),
(70, '', 'honey@gmail.com', '', '', '', '', '', '', 'a55a69a66d9dfdb56e5587f72767d734', 'cOQ9Ewn12t', '', '2016-02-17 11:34:47', NULL, 1, 'valuerater'),
(84, '', 'honey@gmail.com', '', '', '', '', '', '', '059381253c9240107903a6fa30a22476', 'CRzaRNFaA0', '', '2016-02-18 06:56:28', NULL, 1, 'valuerater'),
(83, '', 'honey@gmail.com', '', '', '', '', '', '', '65e1d9a30990e7dbcfcfa1a35767b60d', 'HSJVVZ2omb', '', '2016-02-18 06:55:01', NULL, 1, 'valuerater'),
(82, '', 'honey@gmail.com', '', '', '', '', '', '', 'f0635cf51d53cc628c3919d9ad44192c', '9naHpuQ4Iv', '', '2016-02-18 06:34:25', NULL, 1, 'valuerater'),
(81, '', 'honey@gmail.com', '', '', '', '', '', '', '35f37a1084f4e9a89f1620d57fdad1c0', 'kmJoExbioL', '', '2016-02-18 06:33:08', NULL, 1, 'valuerater'),
(80, '', 'honey@gmail.com', '', '', '', '', '', '', 'b87e93650714de0db3466a34548ccc0b', 'pNumOeVbwO', '', '2016-02-18 06:31:29', NULL, 1, 'valuerater'),
(79, '', 'honey@gmail.com', '', '', '', '', '', '', 'a32bbc3e23b76516a9ea4ed8a126bff1', 'NM7u01AayQ', '', '2016-02-18 06:30:38', NULL, 1, 'valuerater'),
(78, '', 'honey@gmail.com', '', '', '', '', '', '', '417b89d996657cd48aaeb27296053117', '4dffPIKm20', '', '2016-02-17 12:41:32', NULL, 1, 'valuerater'),
(85, '', 'honey@gmail.com', '', '', '', '', '', '', '1135748dcd80da7702e9116e53ad0229', 'ekbDhL5Szf', '', '2016-02-18 06:56:56', NULL, 1, 'valuerater'),
(86, '', 'honey@gmail.com', '', '', '', '', '', '', '848fe9b43652bbfd247c85b8524e1999', '4gmnjFoUmI', '', '2016-02-18 07:36:11', NULL, 1, 'valuerater'),
...
CREATE TABLE `user_executive_summaries` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `user_funding_materials` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Indexes for table `admins_i18n`
--
ALTER TABLE `admins_i18n`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `categories_i18n`
--
...
--
-- Indexes for table `cms_pages_i18n`
--
ALTER TABLE `cms_pages_i18n`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `I18N_LOCALE_FIELD` (`locale`,`model`,`foreign_key`,`field`),
  ADD KEY `I18N_FIELD` (`model`,`foreign_key`,`field`);
...
--
-- Indexes for table `contact_requests_i18n`
--
ALTER TABLE `contact_requests_i18n`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `I18N_LOCALE_FIELD` (`locale`,`model`,`foreign_key`,`field`),
  ADD KEY `I18N_FIELD` (`model`,`foreign_key`,`field`);
...
--
-- Indexes for table `email_templates_i18n`
--
...
--
-- Indexes for table `promo_codes_i18n`
--
ALTER TABLE `promo_codes_i18n`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `I18N_LOCALE_FIELD` (`locale`,`model`,`foreign_key`,`field`),
  ADD KEY `I18N_FIELD` (`model`,`foreign_key`,`field`);
...
--
-- Indexes for table `site_configurations_i18n`
--
ALTER TABLE `site_configurations_i18n`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `I18N_LOCALE_FIELD` (`locale`,`model`,`foreign_key`,`field`),
  ADD KEY `I18N_FIELD` (`model`,`foreign_key`,`field`);
...
--
-- Indexes for table `users_i18n`
--
ALTER TABLE `users_i18n`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `I18N_LOCALE_FIELD` (`locale`,`model`,`foreign_key`,`field`),
  ADD KEY `I18N_FIELD` (`model`,`foreign_key`,`field`);
...
--
-- Indexes for table `user_executive_summaries`
--
ALTER TABLE `user_executive_summaries`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `user_funding_materials`
--
ALTER TABLE `user_funding_materials`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `admins_i18n`
--
ALTER TABLE `admins_i18n`
...
--
-- AUTO_INCREMENT for table `categories_i18n`
--
ALTER TABLE `categories_i18n`
...
--
-- AUTO_INCREMENT for table `cms_pages_i18n`
--
ALTER TABLE `cms_pages_i18n`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `contact_requests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `contact_requests_i18n`
--
ALTER TABLE `contact_requests_i18n`
...
--
-- AUTO_INCREMENT for table `email_templates_i18n`
--
ALTER TABLE `email_templates_i18n`
...
--
-- AUTO_INCREMENT for table `promo_codes_i18n`
--
ALTER TABLE `promo_codes_i18n`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `site_configurations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `site_configurations_i18n`
--
ALTER TABLE `site_configurations_i18n`
...
--
-- AUTO_INCREMENT for table `users_i18n`
--
ALTER TABLE `users_i18n`
...
--
-- AUTO_INCREMENT for table `user_executive_summaries`
--
ALTER TABLE `user_executive_summaries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `user_funding_materials`
--
ALTER TABLE `user_funding_materials`
